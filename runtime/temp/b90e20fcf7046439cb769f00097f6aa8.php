<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"D:\PHPstudy\PHPTutorial\WWW\thinkphp5\public/../application/admin\view\category\create.html";i:1592807946;s:78:"D:\PHPstudy\PHPTutorial\WWW\thinkphp5\application\admin\view\Public\style.html";i:1590719150;s:79:"D:\PHPstudy\PHPTutorial\WWW\thinkphp5\application\admin\view\Public\script.html";i:1590719150;}*/ ?>
<!DOCTYPE html>
        ...
        <script>layui.use(['form', 'layer','jquery'],
            function() {
                ...
                function(data) {
                    ...
                    //发异步，把数据提交给php
                    $.ajax({
                        url:'<?php echo url("Category/store"); ?>',
                        type:'post',
                        timeout:"3000",
                        dataType : 'json',
                        cache:"false",
