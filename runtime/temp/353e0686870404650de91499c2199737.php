<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\PHPstudy\PHPTutorial\WWW\thinkphp5\public/../application/admin\view\article\create.html";i:1594196165;s:78:"D:\PHPstudy\PHPTutorial\WWW\thinkphp5\application\admin\view\Public\style.html";i:1590719150;s:79:"D:\PHPstudy\PHPTutorial\WWW\thinkphp5\application\admin\view\Public\script.html";i:1590719150;}*/ ?>
<!DOCTYPE html>
                ...
                <form class="layui-form" id="art_form" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block layui-upload">
                            ...
                            <input type="file" name="thumb" id="filed" accept="image/*" style="display: none;">
                        </div>
                    </div>
        ...
        <script>
            ...
            function() {
                ...
                function(data) {
                    ...
                    $.ajax({
                        url: "<?php echo url('Article/store'); ?>",
                        type: 'POST',
                        cache: false,
                        data: formData,
